...
S_GROUP = environ.get('S_GROUP', "pibliclink538")
S_CHANNEL = environ.get('S_CHANNEL', "lucky_hub76")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/xmovieshub56')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+PFBmQ5MMPfwxZjk1')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/+__50Mdpu34k5YjU9')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002176735817')).split()]
